function CGsimEnsembleFwd(ens_id,m_prior,opt,outdir,tRun,cModel,W_fine,cState0)
...
%% Simulate Model
[~,states] = simulateScheduleAD(cState0, cModel, cPredSched);
%% Plot Check
...
for i=1:tRun
    ...
    %change monitor bhp with gridb pressure
    %ind (2)M1:50, (3)M2:146, (4)M3:55
    bhp(2)=states{i}.pressure(50);
    bhp(3)=states{i}.pressure(146);
    bhp(4)=states{i}.pressure(55);
